...
<body>
	...
	<div class="sidenav">
			...
			<div class="dropdown-container">
				<a href="stockreport.php">WINESS - Low Stock</a>
	...
	<div class="one">
		<div class="row">
			<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
				<div class="column">
					<p>
						<label for="medid">WINESS ID:</label><br>
						<input type="number" name="medid">
					</p>
					<p>
						<label for="medname">WINESS Name:</label><br>
					...
					<p>
						...
						<select id="cat" name="cat">
								...
								<option>Rosé Wines</option>
								<option>Sparkling Wines</option>
						</select>
					</p>
	...
	<?php
		...
		if(mysqli_query($conn, $sql)){
			echo "<p style='font-size:8;'>WINESS details successfully added!</p>";
		} else{
