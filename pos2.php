...
<body>
		...
		<div class="sidenav">
			<h2 style="font-family:Arial; color:white; text-align:center;"> wines Store Management System </h2>
			<a href="adminmainpage.html">Dashboard</a>
			<button class="dropdown-btn">Inventory
			<i class="down"></i>
			</button>
			<div class="dropdown-container">
				<a href="inventory-add.php">Add New wines</a>
			...
			<div class="dropdown-container">
				...
				<a href="expiryreport.php">winess - Soon to Expire</a>
