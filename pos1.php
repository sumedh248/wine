...
<body>
		...
		<div class="sidenav">
			<h2 style="font-family:Arial; color:white; text-align:center;"> WINESS Store Management System </h2>
			<a href="adminmainpage.php">Dashboard</a>
			<button class="dropdown-btn">Inventory
			<i class="down"></i>
			</button>
			<div class="dropdown-container">
				<a href="inventory-add.php">Add New WINESS</a>
			...
			<div class="dropdown-container">
				<a href="stockreport.php">WINESSs - Low Stock</a>
	...
	?>
		...
		<form method="post">
			...
			<option value="0" selected="selected">Select WINESS</option>
	...
	?>  echo isset($row4[1]) ? $row4[1] : '';
	
			<div class="one row" style="margin-right:160px;">
			<form method="post">
					<div class="column">
					
					<label for="medid">WINESS ID:</label>
					<input type="number" name="medid"  value="<?php echo $row4[0]; ?>"readonly ><br><br>
					
					<label for="mdname">WINESS Name:</label>
					<input type="text" name="mdname" value="<?php echo isset($row4[1]) ? $row4[1] : ''; ?>" redonly><br><br>
					...
					&nbsp;&nbsp;&nbsp;
					<input type="submit" name="add" value="Add WINESS">&nbsp;&nbsp;&nbsp;
